...
if __name__ == '__main__':
    ...
    origin_image = Image.open('./images/fisheye_180.jpg')
    origin_arr = np.asarray(origin_image)
    s_origin = SphereImage(origin_arr, ImageType.INSCRIBED, degrees_to_radians(180), equisolid,
                           equisolid_inverse)
    s_destiny = SphereImage(np.zeros([1800, 2880, 3], np.core.uint8), ImageType.CROPPED_CIRCLE,
